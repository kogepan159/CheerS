...
class PartyRepository {
 ...
 Future<OfferResult> getOfferResult(String hostPartyId, User currentUser) async{
    //合コンオファー（いいね）の取得
   ...
   return OfferResult(offers: offers, isOfferedToThisParty: isOfferedToThisParty);
  ...
  Future<List<HostParty>> getParties(ProfileMode profileMode, User profileUser) {
