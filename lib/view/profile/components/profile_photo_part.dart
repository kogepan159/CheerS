      ...
      children: [
        ...
        Padding(
          ...
          child: Container(
              ...
              child:
          InkWell(
                onTap: () => _openProfilePhotoExpandedScreen_1(context,
                    profileUser.photoUrl_1, profileUser.inAppUserName),
                child: Hero(
        ...
        Padding(
          ...
          child: Container(
              ...
              child: Hero(
                ...
                child: Material(
                  child: InkWell(
                    onTap: () => _openProfilePhotoExpandedScreen_2(context,
                        profileUser.photoUrl_2, profileUser.inAppUserName),
                    child: CachedNetworkImage(
